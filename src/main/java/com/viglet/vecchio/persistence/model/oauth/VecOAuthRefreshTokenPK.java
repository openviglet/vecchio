 ...
 */
@Embeddable
public class VecOAuthRefreshTokenPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VecOAuthRefreshTokenPK)) {
			return false;
		}
		VecOAuthRefreshTokenPK castOther = (VecOAuthRefreshTokenPK)other;
		return 
