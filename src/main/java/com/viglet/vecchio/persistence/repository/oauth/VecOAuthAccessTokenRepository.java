...
public interface VecOAuthAccessTokenRepository extends JpaRepository<VecOAuthAccessToken, String> {

	List<VecOAuthAccessToken> findAll();

	Optional<VecOAuthAccessToken> findById(String id);
